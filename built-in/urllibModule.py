...
#如果想模拟浏览器发送GET请求，需要使用Request对象，通过往Request对象添加HTTP头，就可以把请求伪装成浏览器
#模拟iPhone 6去请求豆瓣首页
...
#Handler， 如果还需要更复杂的控制，比如通过一个Proxy去访问网站，需要利用ProxyHandler来处理
#from urllib import request
...
#小结：urllib提供的功能就是利用程序去执行各种HTTP请求。
...
print(fetch_xml('https://www.baidu.com/'))
